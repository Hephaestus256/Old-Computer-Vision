...
#include <windows.h>
#include "stdafx.h"
#include "C:\Users\Owner\Documents\Visual Studio 2010\Library\graphics_2d.h"
#include <list>
...
public:
	...
	window(
		LPCWSTR p_title, HINSTANCE p_instance, int p_cmd_show, 
		double x1 = 0.0, double y1 = 0.0, double x2 = 1.0, double y2 = 1.0)
	{
		...
		if (!init) {
			...
			hAccelTable = LoadAccelerators(p_instance, MAKEINTRESOURCE(IDC_NEW2));
		...
		wcex.hIcon = LoadIcon(p_instance, MAKEINTRESOURCE(IDI_NEW2));
		wcex.hCursor = LoadCursor(NULL, IDC_ARROW);
		wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW+1);
		wcex.lpszMenuName = MAKEINTRESOURCE(IDC_NEW2);
